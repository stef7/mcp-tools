/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: ed3b6571a208e6aa17296d84234485c0)
// Runtime types generated with workerd@1.20260907.1 2026-09-01 
interface __BaseEnv_Env {
	WP: Fetcher /* mcp-wp */;
	FETCH: Fetcher /* mcp-fetch */;
	ARCHIVES: Fetcher /* mcp-archives */;
	UN_DOCS: Fetcher /* mcp-un-docs */;
	ABC_SEARCH: Fetcher /* mcp-abc-search */;
	ABC_OMBUDSMAN: Fetcher /* mcp-abc-ombudsman */;
	DATA_GOV_AU: Fetcher /* mcp-data-gov-au */;
	GHOST: Fetcher /* mcp-ghost */;
	APIFY: Fetcher /* mcp-apify */;
	GIFTHORSE: Fetcher /* gifthorse */;
}
